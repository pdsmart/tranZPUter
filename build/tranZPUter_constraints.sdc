...
create_generated_clock -name {MEMCLK} -source [get_ports {CLOCK_12M}] -duty_cycle 50.000 -multiply_by 25 -divide_by 6 -phase 0000 -master_clock {clk_12} [get_nets {mypll|altpll_component|_clk1}] 
